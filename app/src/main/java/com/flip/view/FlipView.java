...
public class FlipView extends ViewFlipper implements FlipImp, View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (!animateDesignChildViewsOnly) {
            // FrontView
            int frontLayout = a.getResourceId(R.styleable.FlipView_frontLayout, R.layout.flip_layout_front);
            ...
            // RearView
            int rearLayout = a.getResourceId(R.styleable.FlipView_rearLayout, R.layout.flip_layout_rear);
            ...
            int rearImage = a.getResourceId(R.styleable.FlipView_rearImage, R.mipmap.ic_launcher);
    ...
    private void initInAnimation(@IntRange(from = 0) long duration) {
        if (getInAnimation() == null)
            this.setInAnimation(getContext(), R.anim.flip_x_grow);
    ...
    private void initOutAnimation(@IntRange(from = 0) long duration) {
        if (getOutAnimation() == null)
            this.setOutAnimation(getContext(), R.anim.flip_x_shrink);
    ...
    public void setRearImageAnimation(@AnimRes int animationResId) {
        try {
            setRearImageAnimation(AnimationUtils.loadAnimation(getContext(), animationResId > 0 ? animationResId : R.anim.flip_scale_up));
    ...
    public void setFrontLayout(@LayoutRes int layoutResId) {
        if (layoutResId == R.layout.flip_layout_front) {
    ...
    public void addRearLayout(@LayoutRes int layoutResId) {
        if (layoutResId == R.layout.flip_layout_rear) {
