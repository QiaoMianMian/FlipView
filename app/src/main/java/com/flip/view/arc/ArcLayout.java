...
public class ArcLayout extends ViewGroup {
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        boolean isArcFreeAngle = a.getBoolean(R.styleable.arc_ArcLayout_arc_freeAngle, DEFAULT_FREE_ANGLE);
        boolean isArcReverseAngle = a.getBoolean(R.styleable.arc_ArcLayout_arc_reverseAngle, DEFAULT_REVERSE_ANGLE);
        a.recycle();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        size.x = ArcUtils.computeMeasureSize(widthMeasureSpec, arcDrawable.getIntrinsicWidth());
        size.y = ArcUtils.computeMeasureSize(heightMeasureSpec, arcDrawable.getIntrinsicHeight());
    ...
    protected void childMeasureBy(View child, int x, int y) {
        ...
        switch (lp.width) {
            case LayoutParams.MATCH_PARENT:
                widthSize = ArcUtils.computeWidth(origin, size.x, x);
        ...
        switch (lp.height) {
            case LayoutParams.MATCH_PARENT:
                heightSize = ArcUtils.computeHeight(origin, size.y, y);
